            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-md-push-4">
                        ...
                        <p><i class="icon-email"></i> amandardg32@gmail.com</p>
                        <br>

                        <div class="row">
                            <form name="fcontato" action="" method="post">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="nome" class="sr-only">Nome</label>
                                        <input placeholder="Nome completo" id="nome" name="nome" type="text" class="form-control input-lg" required>
                                    </div>	
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input placeholder="Informe seu telefone" id="tel" name="tel" type="tel" class="form-control input-lg" required>
                            </div>	
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input placeholder="Assunto" pattern="[a-zA-Z0-9]+" id="assunto" name="assunto" type="text" class="form-control input-lg" required>
                            </div>	
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea placeholder="Informe a mensagem" id="mensagem" name="mensagem" class="form-control input-lg" rows="5" required></textarea>
                            </div>	
                        </div>

                        <div class="col-md-12">
                            <div class="form-group">
                                <input type="submit" name="btnEnviar" class= "btn btn-primary" value="Enviar mensagem">
                                <input type="reset" class="btn btn-outline  " value="Limpar formulário">
                            </div>	
                        </div>
