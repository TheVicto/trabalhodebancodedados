  ...
  <body class="fixed-nav sticky-footer bg-dark" id="page-top">
    ...
    <div class="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        $sql = "SELECT * FROM tbcliente LIMIT $inicial, $registros";
        $query = mysqli_query($con, $sql);
        ...
        while($dados = mysqli_fetch_assoc($query)){
                        ...
                        echo "</td>";
                        echo "<td>
                        <a class='btn btn-danger glyphicon glyphicon-trash'  href='index.php?del=".$dados['idcliente']."'> Remover</a>
                        </td>
                        </tr>";
...
$sql = "DELETE FROM tbcliente WHERE idcliente = '$cliente'";
