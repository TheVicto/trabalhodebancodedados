    ...
    <div class="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Carros Locados</li>
        </ol>
        ...
        $sql = "SELECT * FROM locacao LIMIT $inicial, $registros";
        $query = mysqli_query($con, $sql);
        ...
        while($dados = mysqli_fetch_assoc($query)){
                        ...
                        echo "</td>";
                        echo "<td>
                        <a class='btn btn-danger glyphicon glyphicon-trash'  href='locados.php?del=".$dados['id']."'> Remover</a>
                        </td>
                        </tr>";
