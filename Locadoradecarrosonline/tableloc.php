...
$sql = "INSERT INTO tblocacao (nomecliente, sobrenome, datanascimento, cpf, telefone, cidade, email, senha, datalocacao, datadevolucao, modeloveiculo, placa ) VALUES ('".$nome."', '".$sobrenome."', '".$datanascimento."', '".$cpf."', '".$telefone."', '".$cidade."', '".$email."', '".$senha."', '".$datalocacao."', '".$datadevolucao."', '".$veiculo."', '".$placa."')";
     ...
     <div class="row">
        <div class="col-xs-5 elVal form-group">
              <label for="DataNascimento"><span class="req">*</span> Data de Nascimento:</label>
                <input type="text" style="background-color: #fff;" name="datanascimento" id="datanascimento" class="input-text expand form-control" placeholder="AAAA/MM/DD"/>
            </div>
        <div class="col-xs-5 elVal form-group">
      ...
      <div class="col-xs-5 elVal">
         <div class="form-group">
            <span class="req">*</span> Data da Locação <span class="fa fa-info-circle"></span></label>
                <input autocomplete="off" name="datalocacao" type="text" id="datalocacao" class="input-text expand form-control" placeholder="28/11/2017">
         </div>
      </div>
...
<div class="col-xs-5 elVal">
    <div class="form-group">
       <span class="req">*</span> Data da Devolução <span class="fa fa-info-circle"></span></label>
         <input autocomplete="off" name="datadevolucao" type="text" id="datadevolucao" class="input-text expand form-control" placeholder="28/11/2017">
         </div>
      </div>
  </div>
